...
import {
    View, Text, StyleSheet, Switch, Picker,
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.container}>
                        <Card style={styles.form}>
                            ...
                            {!state.age.isValid && <Text style={Platform.select({ios: styles.errorTextIos, android:styles.errorText})}>{state.age.errorMessage}</Text>}
